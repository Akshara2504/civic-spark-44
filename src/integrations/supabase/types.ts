  ...
  public: {
    Tables: {
      ...
      escalations: {
        ...
        Relationships: [
          {
            foreignKeyName: "escalations_from_official_id_fkey"
            columns: ["from_official_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "escalations_to_official_id_fkey"
            columns: ["to_official_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      profiles: {
        Row: {
          ...
          email: string
          id: string
          language_pref: Database["public"]["Enums"]["language_code"] | null
          level: number | null
          name: string
          phone: string | null
      ...
      sos_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "sos_alerts_issue_id_fkey"
            columns: ["issue_id"]
            isOneToOne: false
            referencedRelation: "issues"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "Citizen" | "Official" | "HigherOfficial" | "Admin"
      issue_status:
        | "Reported"
        | "In Progress"
        | "Escalated"
